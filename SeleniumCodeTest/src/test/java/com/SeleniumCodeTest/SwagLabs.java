...
public class SwagLabs {
	...
	public void sortProducts() {
		...
		sortItem.items("Price (high to low)");
		sortItem.items("Name (Z to A)");
		sortItem.items("Name (A to Z)");
		sortItem.items("Price (low to high)");		
	}
	
	@Test(priority = 1)
	public void addProductsToCart() {
		//
		WebElement itemName = driver.findElement(By.xpath("//div[.//div[text()='Sauce Labs Backpack']]/a/ancestor::div[@class='inventory_item_label']/following-sibling::div[@class='pricebar']/button"));
		itemName.click();
